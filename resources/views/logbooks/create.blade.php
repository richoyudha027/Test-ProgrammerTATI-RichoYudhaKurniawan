                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('logbooks.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="logbookForm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="flex flex-col space-y-6">
                                <div class="flex flex-col">
                                    ...
                                    <input type="date" name="date" required class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Masukkan aktivitas Anda (maksimal 800 karakter)"></textarea>
                        ...
                        <div class="flex justify-between">
                            ...
                            <button type="submit" id="submitBtn" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-800">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
